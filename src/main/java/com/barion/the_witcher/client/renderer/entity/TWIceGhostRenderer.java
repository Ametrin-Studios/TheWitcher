...
public final class TWIceGhostRenderer extends MobRenderer<TWIceGhostEntity, TWIceGhostRenderState, TWIceGhostModel> {
    private static final ResourceLocation TEXTURE = TheWitcher.locate("textures/entity/ice_ghost.png");
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(TheWitcher.locate("ice_ghost"), "main");
