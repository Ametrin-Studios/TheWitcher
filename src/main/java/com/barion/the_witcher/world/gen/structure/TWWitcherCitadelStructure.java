...
public class TWWitcherCitadelStructure extends Structure {
    ...
    public static final MapCodec<TWWitcherCitadelStructure> CODEC = Structure.simpleCodec(TWWitcherCitadelStructure::new);

    public TWWitcherCitadelStructure(StructureSettings settings) {
        super(settings);
    }
    ...
    public @NotNull StructureType<?> type() {
        return TWStructures.WITCHER_CITADEL.getType();
    }
    ...
    public static class Piece extends GelTemplateStructurePiece {
        public Piece(StructureTemplateManager structureManager, BlockPos pos, RandomSource random) {
            super(TWStructures.WITCHER_CITADEL.getPieceType().get(), 0, structureManager, StructureFile, pos);
        ...
        public Piece(StructurePieceSerializationContext context, CompoundTag nbt) {
            super(TWStructures.WITCHER_CITADEL.getPieceType().get(), nbt, context.structureTemplateManager());
