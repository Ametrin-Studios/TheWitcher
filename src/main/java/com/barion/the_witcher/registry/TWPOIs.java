...
public final class TWPOIs {
    ...
    public static final DeferredHolder<PoiType, PoiType> WHITE_FROST_PORTAL = REGISTER.register("white_frost_portal", ()-> new PoiType(ImmutableSet.copyOf(TWBlocks.WHITE_FROST_PORTAL.get().getStateDefinition().getPossibleStates()), 0, 1));
