...
public final class TWPotions {
    ...
    public static final DeferredHolder<Potion, Potion> ENERGY_REGENERATION_POTION = REGISTER.register("energy_regeneration_potion", ()-> new Potion("energy_regeneration_potion", new MobEffectInstance(TWEffects.ENERGY_REGENERATION, 6000, 0)));
    ...
    public static final DeferredHolder<Potion, Potion> FROST_RESISTANCE_POTION = REGISTER.register("frost_resistance_potion", ()-> new Potion("frost_resistance_potion", new MobEffectInstance(TWEffects.FROST_RESISTANCE, minutesToTicks(20), 0)));
