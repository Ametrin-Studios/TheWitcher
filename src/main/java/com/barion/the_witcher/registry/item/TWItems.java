...
public final class TWItems {
    ...
    public static final DeferredItem<ItemNameBlockItem> WHITE_MYRTLE = register("white_myrtle", () -> new ItemNameBlockItem(TWBlocks.WHITE_MYRTLE_BUSH.get(), DEFAULT_PROPERTIES));
    public static final DeferredItem<ItemNameBlockItem> CELANDINE = register("celandine", () -> new ItemNameBlockItem(TWBlocks.CELANDINE_BUSH.get(), DEFAULT_PROPERTIES));
    ...
    public static final DeferredItem<PortalCatalystItem> ICE_STUFF = register("ice_stuff", ()-> new PortalCatalystItem(TWPortals.WHITE_FROST, properties().stacksTo(1).rarity(Rarity.EPIC)));
