...
import com.barion.the_witcher.world.item.TWArmors;
...
public class TWItems {
    ...
    public static final Item.Properties DEFAULT_PROPERIES = properties();

    public static final DeferredItem<Item> TAB_LOGO = REGISTER.register("tab_logo", () -> new Item(new Item.Properties()));

    public static final DeferredItem<Item> RAW_SILVER = register("raw_silver", item(DEFAULT_PROPERIES));
    public static final DeferredItem<Item> SILVER_INGOT = register("silver_ingot", item(DEFAULT_PROPERIES));
    public static final DeferredItem<Item> SILVER_NUGGET = register("silver_nugget", item(DEFAULT_PROPERIES));
    ...
    public static final DeferredItem<Item> STEEL_INGOT = register("steel_ingot", item(DEFAULT_PROPERIES));
    public static final DeferredItem<Item> STEEL_NUGGET = register("steel_nugget", item(DEFAULT_PROPERIES));
    ...
    public static final DeferredItem<CustomArmorItem> REINFORCED_LEATHER_HELMET = register("reinforced_leather_helmet", ()-> new CustomArmorItem(TWArmors.ReinforcedLeather, EquipmentSlot.HEAD, properties()));
    public static final DeferredItem<CustomArmorItem> REINFORCED_LEATHER_CHESTPLATE = register("reinforced_leather_chestplate", ()-> new CustomArmorItem(TWArmors.ReinforcedLeather, EquipmentSlot.CHEST, properties()));
    public static final DeferredItem<CustomArmorItem> REINFORCED_LEATHER_LEGGINGS = register("reinforced_leather_leggings", ()-> new CustomArmorItem(TWArmors.ReinforcedLeather, EquipmentSlot.LEGS, properties()));
    public static final DeferredItem<CustomArmorItem> REINFORCED_LEATHER_BOOTS = register("reinforced_leather_boots", ()-> new CustomArmorItem(TWArmors.ReinforcedLeather, EquipmentSlot.FEET, properties()));
    ...
    public static final DeferredItem<Item> HOT_WATER_BOTTLE = register("hot_water_bottle", () -> new TWHotWaterBottleItem(properties().stacksTo(4).craftRemainder(Items.GLASS_BOTTLE).food(TWFoodProperties.HotWaterBottle)));
    ...
    public static final DeferredItem<SpawnEggItem> WILD_HUNT_KNIGHT_SPAWN_EGG = register("wild_hunt_knight_spawn_egg", ()-> new DeferredSpawnEggItem(TWEntityTypes.WILD_HUNT_KNIGHT, -16777216, -6684673, DEFAULT_PROPERIES));
    public static final DeferredItem<SpawnEggItem> WILD_HUNT_HOUND_SPAWN_EGG = register("wild_hunt_hound_spawn_egg", ()-> new DeferredSpawnEggItem(TWEntityTypes.WILD_HUNT_HOUND, -13421773, -16737895, DEFAULT_PROPERIES));
    public static final DeferredItem<SpawnEggItem> ICE_GHOST_SPAWN_EGG = register("ice_ghost_spawn_egg", ()-> new DeferredSpawnEggItem(TWEntityTypes.ICE_GHOST, -13369345, -16776961, DEFAULT_PROPERIES));

    public static final DeferredItem<PortalCatalystItem> ICE_STUFF = register("ice_stuff", ()-> new PortalCatalystItem(TWBlocks.WHITE_FROST_PORTAL, TheWitcher.WHITE_FROST, properties().stacksTo(1).rarity(Rarity.EPIC)));
...
//    public static final DeferredItem<BucketItem> ACID_BUCKET = register("acid_bucket", ()-> new BucketItem(TWFluids.SOURCE_ACID.get(), properties().craftRemainder(Items.BUCKET).stacksTo(1)));
    ...
    private static Supplier<ItemNameBlockItem> blockItem(Supplier<? extends Block> block) {return () -> new ItemNameBlockItem(block.get(), DEFAULT_PROPERIES);}
