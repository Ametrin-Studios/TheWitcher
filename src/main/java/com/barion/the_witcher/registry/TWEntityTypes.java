...
public final class TWEntityTypes {
    public static final DeferredRegister<EntityType<?>> REGISTER = DeferredRegister.createEntities(TheWitcher.MOD_ID);
    ...
    private static <E extends Entity> DeferredHolder<EntityType<?>, EntityType<E>> register(String id, EntityType.Builder<E> builder) {
        return REGISTER.register(id, () -> builder.build(ResourceKey.create(BuiltInRegistries.ENTITY_TYPE.key(), TheWitcher.locate(id))));
    }
}